...
#CUDA_VISIBLE_DEVICES="4,5,6" python -m torch.distributed.launch --nproc_per_node 2  --master_port 9910 test_refine.py --name refine-G-1-nofakeatt-noeffect-estep10 --dataset_mode Eadebox --gpu 0,1 --netG spadeunet2 --no_instance --no_skip_connections --batchSize 2 --mix_input_gen --nThreads 0 --bbox --segmentation_mask --dataroot ../../datasets/ade20k/ --netE vae --vae  --eord --removal
#CUDA_VISIBLE_DEVICES="4,5,6" python -m torch.distributed.launch --nproc_per_node 2  --master_port 9910 test_refine.py --name refine-G-1-nofakeatt-noeffect-estep10 --dataset_mode Eadebox --gpu 0,1 --netG spadeunet2 --no_instance --no_skip_connections --batchSize 2 --mix_input_gen --nThreads 0 --bbox --segmentation_mask --dataroot ../../datasets/ade20k/ --netE vae --vae  --eord --addition
