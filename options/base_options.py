...
class BaseOptions():
    ...
    def initialize(self, parser):
        ...
        # for setting inputs
        parser.add_argument('--dataroot', type=str, default='../../datasets/cityscape/')
        ...
        parser.add_argument('--eord', action='store_true', help='use erode or dilate to augment the dataset')
        ...
        parser.add_argument('--divco', action='store_true')
        parser.add_argument('--modeseek', action='store_true')
    ...
    def gather_options(self):
        ...
        # opt = parser.parse_args(args=["--name","test_dataloader","--dataset_mode","cityscapesbox","--netG","Unet","--gpu","0","--no_instance","--no_skip_connections",
        #             "--batchSize","2","--mix_input_gen","--nThreads","0","--bbox","--segmentation_mask"])
        self.parser = parser
        return opt
