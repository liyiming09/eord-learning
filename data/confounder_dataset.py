...
import os.path
from data.baseconfounder_dataset import BaseDataset, get_transform_params, get_transform_fn, normalize, get_masked_image, get_soft_bbox
from data.baseconfounder_dataset import get_raw_transform_fn
...
class SegmentationDataset(BaseDataset):
    ...
    def __getitem__(self, index):
        ...
        params_list = get_transform_params(full_size, inst_info,
