...
def main():
    ...
    for i, data_i in enumerate(dataloader):
        ...
        generated, masked_image, semantics_seq = model(data_i, mode='baseline_inference')
        ...
        for b in range(ran):
            ...
            # mask = semantics[b][-1]
            # mask_true_neg = semantics_seq[1][b:b+1]
            # mask_pos, mask_neg = semantics_seq[2][b:b+1], semantics_seq[3][b:b+1]    #note1!!!!!!!!!!!!1
